...
const imagePairs = [
  {
    before: "/portfolio/Fenton/Fenton_before1.jpg",
    after: "/portfolio/Fenton/Fenton_after2.jpg",
  },
  {
    before: "/portfolio/Fenton/Fenton_before2.jpg",
    after: "/portfolio/Fenton/Fenton_after1.jpg",
  },
  {
    before: "/portfolio/Fenton/Fenton_before3.jpg",
    after: "/portfolio/Fenton/Fenton_after3.jpg",
  },
];

export default function Fenton() {
    ...
    <section className="pt-24 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          clearing, and redefining the landscape edges to create a cleaner,
          safer, and more professional-looking outdoor area. The results brought
          visibility back to the storefront, boosted curb appeal, and restored
          structure to an otherwise neglected parking zone.
        </p>
          ...
          {imagePairs.map((pair, index) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`
                    relative w-full h-64 transition-transform duration-700
